      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>İbrahim</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop mobile applications, <br className='sm:block hidden' />
            AI solutions and web technologies
          </p>
          ...
          <div className='flex gap-4 mt-8 pointer-events-auto'>
            ...
            <motion.a
              href='https://linkedin.com/in/ibrahimysr'
              target='_blank'
              rel='noopener noreferrer'
              whileHover={{ scale: 1.1, y: -3 }}
              whileTap={{ scale: 0.95 }}
              className='w-12 h-12 rounded-full bg-tertiary border-2 border-[#00cea8]/30 hover:border-[#00cea8] flex items-center justify-center text-secondary hover:text-[#00cea8] transition-all duration-300 shadow-lg hover:shadow-[#00cea8]/50'
              aria-label='LinkedIn'
            >
              <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24'>
            ...
            <motion.a
              href='mailto:ibrahimyasar2701@gmail.com'
              whileHover={{ scale: 1.1, y: -3 }}
              whileTap={{ scale: 0.95 }}
            ...
            <motion.a
              href='https://www.instagram.com/ibrahimysr.00/'
              target='_blank'
              rel='noopener noreferrer'
              whileHover={{ scale: 1.1, y: -3 }}
              whileTap={{ scale: 0.95 }}
